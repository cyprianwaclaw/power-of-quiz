  ...
  <NuxtLayout name="default">
    <div class="flex flex-col justify-center w-full mb-10  lg:mb-16  mt-4 md:mt-5 lg:mt-8">
      <div class="flex items-place-center">
        <div class="md:flex">
          <img :src="currentUser.avatar_path" v-if="currentUser.avatar_path" class="avatar h-[52px] lg:h-[72px]" />
    ...
    <div class="hidden md:grid grid-cols-2 grid-rows-1 gap-8">
      ...
      <div class="gap-8 grid">
        <PakietAddUser text="Zyskaj bonus od 11 do 36 punktów, za każdego poleconego, który wykupi pakiet Premium" />
