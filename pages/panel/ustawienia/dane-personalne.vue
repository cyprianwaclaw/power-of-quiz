    ...
    <NuxtLayout name="edit-settings">
      ...
      <div class="grid place-items-center">
        <div v-if="user.avatar_path" class="relative">
          ...
          <div  @click="isModal()">
            <div class="bg-gray-500 w-8 h-8 border-none rounded-full absolute bottom-2 right-0">
              <Icon name="ph:camera" color="white" size="20"  class="camera" />
            </div>
          </div>
        </div>
        <div class="relative" v-else>
          <Icon name="carbon:user-avatar-filled" color="#BFCBEE" class="w-36 h-36 relative" />
          <div  @click="isModal()">
