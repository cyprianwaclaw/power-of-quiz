<template>
  <ModalAlert :modalActive="isOpen" title="Usuń quiz"
    des="Czy na pewno chcesz usunąć quiz? Tej operacji nie będzie można cofnąć" closeButton="Anuluj" actionButton="Usuń"
    actionButtonClass="text-red-500" @close="isModal()" @action="removeQuiz" />
  <ModalAlert :modalActive="isRemoveSucessModal" title="Usunięto quiz" des="Twój quiz został usunięty" closeButton="Okej"
  ...
  <NuxtLayout name="single-quiz">
    ...
    <div class="grid grid-cols-2 md:gap-20">
      <div class="flex flex-col md:hidden">
        ...
        <p class="text-[18px] font-semibold mb-[3px] mt-9" v-if="quizStore.singleQuiz.description">
          Opis
        </p>
      ...
      <div>
        ...
        <WhiteRetangleContainer :array="[...questionArray]" />
      </div>
      <div class="md:flex md:flex-col hidden">
        ...
        <div class="white-retangle1 mt-10">
          <div class="row-table1 place-items-center" v-for="(single, index) in quizArray" :key="index"
