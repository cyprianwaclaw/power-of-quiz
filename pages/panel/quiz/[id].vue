...
// !test
const firstQuestion = useCookie('firstQuestion') as any
// firstQuestion.value = startQuiz.value.data
const current = ref(null) as any;
current.value = firstQuestion.value
// !test
...
const postAnswer = async (question_id: any, ansewer_id: any) => {
  await quizState.postAnswerNextQuestion(submission.value, question_id, ansewer_id);
