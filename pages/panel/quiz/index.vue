...
const pagination = () => {
  ...
  const countPageArray1 = countPageArray.slice(allQuiz.value.current_page - 2, allQuiz.value.current_page + 2);

//   console.log(allQuiz.value.current_page - 2)
//   setTimeout(()=>{
//     countPageArray.value = countPageArray.value
// }, 100)
