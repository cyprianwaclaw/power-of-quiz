<template>
  <div v-if="isOpen">
    ...
    >
    <template #content>
      <ModalContentSelectAction
      @close= "isClose" 
      />
    </template>
    </ModalDown>
  </div>
<div class="px-2 py-2 border-t border-gray-200  fixed left-0 bottom-0 z-30 grid grid-cols-5 w-full h-70 bg-white justify-items-center " >
